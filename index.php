...
$fs= $_FILES['img']['size'];
$fe= $_FILES['img']['error'];
$ftmp=$_FILES['img']['tmp_name'];	//C:\wamp\tmp\phpF6A0.tmp"
...
if(($imgid !=null||$headline !=null ) && $userid !=null ){
	 ...
	 if($imgid!=null && $headline!=null)
	      $msg['post']=$ftmp;
			...
			$msg['post']="($ exec) تم رفع صوره واحده";
			 else if($imgid==null && $headline!=null)
		  $msg['post']="$exec تم رفع منشور واحد بدون ";
		}
...
<div class="w3-content w3-padding" style="max-width:1564px">
	...
	$vid=explode(".", $path);
	$pa=strtolower($vid[0]);
	$vidpath=strtolower(end($vid));
	if($vidpath=="mp4" ||$vidpath=="Mp4"||$vidpath=="MP4"){ 
	 ?>
	 <video width="500" height="200" autoplay="autoplay" controls="controls"
	  preload="preload">
	  < source src="<?php echo $path;?>"/>
	  < source src="<?php echo $pa;?>.ogv"/>
	  < source src="<?php echo $pa;?>.webm"/>
	       </video> 
...
?>
	  <div class="blog-img">
	   <img src="<?php echo $path;?>" alt="<?php echo $i['username'];?>" style="width:100%">
      	<?php 
      		}
      	?>
