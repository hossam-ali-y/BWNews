...
if($db){
	 ...
	 if($result&&$result1){                                 
		 ...
		 $msg['name'] = 'Wrong password';
		  ...
		  $msg['name'] = 'Invalid User With <b>'.$_POST['u_name'].'</b>&nbsp;pleas SignUp';
		  //$result=getResult();
...
if(!preg_match("/^[A-Z]\w{a,}$/",$tx['name']))
$msg['name']="username must contain number & capital letters only";
...
if(!preg_match("/^(\d|\w)*\d+[a-zA-Z]+\W*$/",$tx['pass']))
$msg['pass']="password must contain number & letters only";
}
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
	  ...
	  <li><a href="admin/ad.php">Admin</a></li>
	  <li><a href="#">About we</a></li>
	  <li><a href="#">About my site</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="getaccount.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
      <li><a href="get.php"  onclick="document.getElementById('id01').style.display='block'" ><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
    </ul>
  </div>
</nav>
...
<div class="w3-container">
    <div  id="id01" class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:500px" >
      ...
      <div class="w3-center">
		...
		<h4><span  class="glyphicon glyphicon-log-in ">_Login User</span></h4>
      </div>
	   ...
	   <form class = "w3-container" role = "form" action="get.php"method="POST">
        <div class="w3-section">
          ...
          <input class="w3-input w3-border" id="name" type="gmail"  name="u_name"
           value="<?php if(isset($_COOKIE['name']))echo$_COOKIE['name']; else echo $tx['name'];?>" placeholder="Enter Username" required>
		  
           <input type='text' name='u_sname' value="<?php ;?>" hidden>
		   
		  <label><b>Password</b></label>
          <input  class="w3-input w3-border" id="pass" type="password" name="u_pass" 
		  value="<?php if(isset($_COOKIE['pass'])) echo $_COOKIE['pass'];?>" placeholder="Enter Password"   required>
		  <?php 
